...
Infine implementare il codice necessario che si occupa di stampare in console la 
persona e il tipo di lavoro trovato. N.B: la stampa dei risultati deve avvenire solo 
nel momento in cui entrambe le Promise sono state risolte.
...
Promise.all([fetchPersonById(id), fetchJobById(id)]).then(success =>{
    console.log(success);
}).catch((error) => {
    console.log(error);
});

// Esercizio svolto in pair con Paolo
